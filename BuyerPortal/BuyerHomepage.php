...
<body>
	...
	<br>
	<div class=content_item><label style="font-size :30px; text-shadow: 1px 1px 1px gray;"><b>Best Animals and Products</b></label></div>
	<div id="ani">
		<?php getAnimalsandProductsHomepage(); ?>
