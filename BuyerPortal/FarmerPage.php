     ...
     <script>
          function state() {
               ...
               if (a === '31') {
                    ...
                    var array = ['Panchkula *', 'Ambala', 'Yamunanagar', 'Kuruetra', 'Kaithal', 'Karnal', 'Panipat', 'Sonipat', 'Jind', 'Fatehabad *', 'Sirsa', 'Hisar', 'Bhiwani', 'Rohtak', 'Jhajjar *', 'Mahendragarh', 'Rewari', 'Gurgaon', 'Faridabad'];
               } else if (a === '06') {
...
<body>
     ...
     <div class="headerdown">
          <div id="show">
               ...
               <div class="sel4 sel">
				<button class="btn btn-default dropdown-toggle" type="button" id="menu1" data-toggle="dropdown">ANIMALS AND PRODUCTS </i>
					<span class="caret"></span></button>
				<ul class="dropdown-menu ">
					<?php getAnimalsandProducts(); ?>
				</ul>
			</div>
          </div>
...
<div class="address"><p class="state">newyork,USA</p>
  ...
  <div class="right-side">
     ...
     <div class='inputwrapper'>
          ...
          <label>PRICE:- $product_price Ksh/kg</label><br>
