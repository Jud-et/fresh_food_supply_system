...
<div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <div class="input-group mb-1 ml-2 searchbox">
        ...
        <form action="SearchResult.php" method="get" enctype="multipart/form-data">
            <input type="text" class="form-control " id="inlineFormInputGroup" name="search" placeholder="Search for fruits,vegetables crops or Animals and Products " style="width:500px;">
        </form>
    </div>
    <?php
    getUsername();
        ...
        <div class="d-flex justify-content-around bg-white mb-3">
            ...
            <div class="p-2 ">
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                        <a class="dropdown-item" href="#">Chiken</a>
                        <a class="dropdown-item" href="#">Goat</a>
            ...
            <div class="p-2 ">
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                        ...
                        <a class="dropdown-item" href="#">Sweet potatoes</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col col-12 col-sm-12 col-md-4 col-xl-4 col-lg-4">
                <div class="card pl-3 pr-3 pb-0 pt-2 mt-2 ">
                    <br>
                    <div><b>
                            <h3><img src="iconsmall.png"> Doreen
                        </b></h3>
                    </div>
