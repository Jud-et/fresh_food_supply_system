...
<body>
    ...
    <nav class="navbar navbar-expand-xl ">
        ...
        <div class=" flex-row-reverse left ">
            ...
            <a class="float-left" href="bhome.php">
                <img src="" class="float-left mr-5 ml-0 " alt="Logo" style="height:50px;">
            </a>
        </div>
        ...
        <a class="float-left" href="bhome.php">
            <img src="" class="float-left mr-2 moblogo" alt="Logo" style="height:50px;">
        </a>
    ...
    <div class="container"> <img src="b4.png" class="img-fluid firstimage d-block mx-auto" alt="Responsive image">
    </div>
    <br>
    <br>
    ...
    <div class="container">
        <div class="text-center">
            <!-- <h2 id="headings" class="destext">Animals and Products</h2> -->
            <h1 id="headings" class="guard"><span><b>Animals and Products </b></span>
            </h1>
        </div>
    ...
    <div class="container">
        ...
        <div class="text-center">
            <h1 id="headings" class="longguard"><span><b>Best Selling Products All Over Kiambu </b></span>
            </h1>
        </div>
        <br>
        <div class="row">
