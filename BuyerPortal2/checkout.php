        ...
        <div class="container mt-2">
            ...
            <form>
                <div class=" float-none float-sm-none float-md-none float-lg-right float-xl-rightcheckout mr-0 p-2 mb-5   " style="border-radius:5%;">
                    <h4 style="font-family: sans-serif"><b>Grand total = Ksh. <?php echo $_SESSION['grandtotal']; ?> </b></h4>
                </div>
...
if (isset($_POST['submit'])) {
    ...
    // Check if total amount is above 1000 ksh for delivery option
    if ($total > 1000 && $delivery == 'delivery') {
        // If total is above 1000 ksh, set delivery option
        $delivery = 'delivery';
    } else {
        // If total is below 1000 ksh, set pickup option
        $delivery = 'pickup';
    }
