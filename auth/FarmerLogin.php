...
if (isset($_POST['login'])) {
	...
	$query = "SELECT * FROM farmerregistration WHERE farmer_phone = '$phonenumber' AND farmer_password = '$hashed_password'";
	...
	// Assuming you only expect one row for a valid login, you can directly fetch the row
